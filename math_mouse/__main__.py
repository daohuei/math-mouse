...
if __name__ == "__main__":
    ...
    try:
        ...
        main_logger.info(f"The X is :\n{x}")
        main_logger.info(f"The Y is :\n{y}")
        main_logger.info(f"The Weight with Least Square is :\n{b_hat}")
        main_logger.info(f"The RSS is :\n{current_rss}")
        main_logger.info(f"The Prediction is :\n{y_hat}")
